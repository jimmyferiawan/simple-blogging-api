...
-- Dumping data for table blog.user: ~1 rows (approximately)
...
INSERT INTO `user` (`id`, `firstName`, `middleName`, `lastName`, `mobile`, `email`, `passwordHash`, `registeredAt`, `lastLogin`, `intro`, `profile`, `username`, `emailConfirmed`) VALUES
	(1, 'Jimmy', 'Feriawan', '', '087784517748', 'feriawanjimmy@mail.com', '$2b$10$VehOVJirUqtMcdxBZSp44.gNi', '2023-10-13 09:30:08', NULL, NULL, NULL, 'jimmy', 'N');
